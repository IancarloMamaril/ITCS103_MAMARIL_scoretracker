...
tk.Label(window, text="Name").grid(row=1, column=0, padx=15, pady=10, sticky="w")
tk.Label(window, text="Grade").grid(row=2, column=0, padx=15, pady=10, sticky="w")
...
tk.Button(window, text="Submit", command=save_to_excel, width=20, bg="#083ef7", fg="white").grid(row=4, column=1)
tk.Button(window, text="View Stored Data", command=show_data, width=20, bg="#c50625", fg="white").grid(row=5, column=1)
